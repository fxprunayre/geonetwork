...
export * from './lib/modules/record-actions/record-menu/record-menu.component';
...
export * from './lib/modules/record-distributions/add-all-layers-to-map/add-all-layers-to-map';
