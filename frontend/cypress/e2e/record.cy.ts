  ...
  describe('Distribution', () => {
    it('should display the data access tab content', () => {
      ...
      cy.get('[data-testid="distribution-panel-download"]')
        .contains(
          'p-card',
          'surval_parametre_point,surval_parametre_ligne,surval_parametre_polygone',
        )
        .find('ng-icon')
